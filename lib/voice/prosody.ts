...
// Phonetic spellings use no hyphens — hyphens cause micro-pauses on many
// English TTS engines, making Malay speech sound choppy/stuttery. Instead
// we concatenate syllables into one word so the engine reads them as a unit.
const MALAY_PHONETIC: Array<[RegExp, string]> = [
  // Nikah / ceremony
  [/\bbernikah\b/gi,    'berneekah'],
  [/\bnikahkan\b/gi,    'neekahkan'],
  [/\bnikah\b/gi,       'neekah'],
  [/\bakad\b/gi,        'ahkad'],
  [/\bbersanding\b/gi,  'bersahnding'],
  [/\bsanding\b/gi,     'sahnding'],
  [/\bpelamin\b/gi,     'pelahmeen'],
  [/\bpengantin\b/gi,   'penganteen'],
  [/\bberinai\b/gi,     'bereenai'],
  [/\bandaman\b/gi,     'undahmun'],
  [/\bkenduri\b/gi,     'kendooree'],
  [/\bwalimah\b/gi,     'wahleemah'],
  [/\bmajlis\b/gi,      'mahjlis'],
  // People / roles
  [/\bjurunikah\b/gi,   'jooroonicah'],
  [/\bwali\b/gi,        'wahlee'],
  [/\btetamu\b/gi,      'tehtahmoo'],
  [/\bjemputan\b/gi,    'jempootan'],
  // Budget / finance
  [/\bmahar\b/gi,       'mahhar'],
  [/\bhantaran\b/gi,    'huntahrun'],
  [/\bbajet\b/gi,       'bahjet'],
  // Venue / space
  [/\bdewan\b/gi,       'dehwun'],
  [/\bnegeri\b/gi,      'nehgehree'],
  [/\bpejabat\b/gi,     'pehjahbat'],
  // Common words that English TTS distorts
  [/\bselamat\b/gi,     'selahmaat'],
  [/\bterima\b/gi,      'tereemah'],
  [/\bkahwin\b/gi,      'kahwin'],
  [/\bbersama\b/gi,     'bersahmah'],
  [/\btidak\b/gi,       'teedak'],
  [/\bboleh\b/gi,       'bohleh'],
  [/\bsudah\b/gi,       'soodah'],
  [/\bbelum\b/gi,       'behloom'],
  ...
  [/\bdengan\b/gi,      'dengun'],
  [/\bsebab\b/gi,       'sehbab'],
  [/\bkerana\b/gi,      'kehrahnah'],
  [/\bsesama\b/gi,      'sehsahmah'],
  [/\btapi\b/gi,        'tahpee'],
  [/\bjuga\b/gi,        'joogah'],
  [/\bkalau\b/gi,       'kahlau'],
  [/\bpihak\b/gi,       'peehak'],
  [/\bperkara\b/gi,     'perkahrah'],
  [/\bkepada\b/gi,      'kehpahdah'],
  [/\bseperti\b/gi,     'sehpertee'],
];
