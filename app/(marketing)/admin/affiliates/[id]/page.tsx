  ...
  return (
    <div className="admin-page">
      <header className="admin-page__head">
        ...
        <h1>{String(a.name)} <span className={`admin-badge ${s.cls}`}>{s.label}</span></h1>
        ...
        <section className="admin-card">
          ...
          <div className="admin-actions">
            <form action={setAffiliateStatusAction}>
              ...
              <button className="ui-btn ui-btn--sm ui-btn--ok">Luluskan</button>
            </form>
            <form action={setAffiliateStatusAction}>
              <input type="hidden" name="id" value={id} />
              ...
              {detail.users.map((u, i) => {
                ...
                return (
                  <tr key={i}>
                    ...
                    <td><span className={`admin-badge ${us.cls}`}>{us.label}</span></td>
